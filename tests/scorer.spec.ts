...
describe("Scorer", () => {
    describe("profile selection", () => {
        ...
        it("should use the null strategy when no strategy is applied", () => {
            const sut = new Scorer(
                peopleSchemaService,
                [profileDoubleFullName],
                null
            );
        ...
        it("should use the default strategy as fallback", () => {
            ...
            const doc = peopleAnalyzer.analyzeDocument({ id: "1" });
            const bases: ScoringBases = [{ key: "fullName", score: 2 }];
    ...
    describe("scoring", () => {
        ...
        describe("functions", () => {
            describe("magnitude", () => {
                it("should boost numbers by interpolated value", () => {
                    ...
                    const far = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        ratio: 5
                    });
                    const lowNear = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        ratio: 9
                    });
                    const low = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        ratio: 10
                    });
                    const middle = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        ratio: 15
                    });
                    const up = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        ratio: 20
                    });
                    const upNear = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        ratio: 21
                    });

                    const bases: ScoringBases = [{ key: "ratio", score: 3 }];
            ...
            describe("freshness", () => {
                ...
                it("should boost dates until now in a given duration", () => {
                    ...
                    const past = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { createdOn: subtractTime(now, 2) }
                    });
                    const p1dt1s = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { createdOn: subtractTime(now, 1, 0, 0, 1) }
                    });
                    const p1d = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { createdOn: subtractTime(now, 1) }
                    });
                    const pt12h = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { createdOn: subtractTime(now, 0, 12) }
                    });
                    const nowd = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { createdOn: now }
                    });
                    const future = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { createdOn: addTime(now, 0, 0, 0, 1) }
                    });
                ...
                it("should boost dates after now in a given duration", () => {
                    ...
                    const npt12h = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { createdOn: addTime(now, 0, 12) }
                    });
                    const np1d = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { createdOn: addTime(now, 1) }
                    });
                    const np1dt1s = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { createdOn: addTime(now, 1, 0, 0, 1) }
                    });
            ...
            describe("distance", () => {
                it("should boost locations closer to the reference point within a distance radius", () => {
                    ...
                    const d100k200m = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        addresses: [
                            {
                                location: makeGeoJsonPoint(
                    ...
                    const d100k = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        addresses: [
                            {
                                location: makeGeoJsonPoint(
                    ...
                    const d50k = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        addresses: [
                            {
                                location: makeGeoJsonPoint(
                    ...
                    const rp = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        addresses: [
                            {
                                location: makeGeoJsonPoint(
                    ...
                    const strats = sut.getScoringStrategies(null, [
                        "rp--73.5543295037799, 45.50890239725307"
                    ]);
            ...
            describe("tag", () => {
                it("should boost text as a larger proportion of the words are tags", () => {
                    ...
                    const mock = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { tags: ["mock"] }
                    });
                    const mockfoo = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { tags: ["mockfoo"] }
                    });
                    const mock_foo = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { tags: ["mock", "foo"] }
                    });
                    const mock_foobar = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { tags: ["mock", "foobar"] }
                    });
                    const mock_foo_bar = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { tags: ["mock", "foo", "bar"] }
                    });
                    const foo_bar = peopleAnalyzer.analyzeDocument({
                        id: "1",
                        metadata: { tags: ["foo", "bar"] }
                    });

                    const bases: ScoringBases = [{ key: "fullName", score: 3 }];
        ...
        describe("interpolation", () => {
            it("should be linear by default", () => {
                ...
                const start = peopleAnalyzer.analyzeDocument({
                    id: "1",
                    ratio: 10
                });
                const middle = peopleAnalyzer.analyzeDocument({
                ...
                const end = peopleAnalyzer.analyzeDocument({
                    id: "1",
                    ratio: 20
                });
            ...
            it("should get max boost right away with constant", () => {
                ...
                const before = peopleAnalyzer.analyzeDocument({
                    id: "1",
                    ratio: 9
                });
                const start = peopleAnalyzer.analyzeDocument({
                ...
                const after = peopleAnalyzer.analyzeDocument({
                    id: "1",
                    ratio: 21
                });
